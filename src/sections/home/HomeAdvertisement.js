        ...
        <Grid container spacing={6}>
          <Grid item xs={12} sm={12} md={4}>
            <m.div variants={varFade().inUp}>
              <Typography color={theme.palette.design.main} variant="h6">021 701 7172</Typography>
            </m.div>
            <m.div variants={varFade().inUp}>
          ...
          <Grid item xs={12} sm={12} md={4}>
            <m.div variants={varFade().inUp}>
              <Typography color={theme.palette.design.main} variant="h6">info@thechocolateyogi.com</Typography>
            </m.div>
            <m.div variants={varFade().inUp}>
          ...
          <Grid item xs={12} sm={12} md={4}>
            <m.div variants={varFade().inUp}>
              <Typography color={theme.palette.design.main} variant="h6">The Chocolate Yogi</Typography>
            </m.div>
            <m.div variants={varFade().inUp}>
